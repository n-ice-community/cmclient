...
static const NWidgetPart _nested_token_login_widgets[] = {
	...
	EndContainer(),
	NWidget(WWT_PANEL, COLOUR_BROWN), SetFill(0, 1), SetPIP(2, 2, 2),
		NWidget(NWID_VERTICAL), SetPadding(0, 5, 0, 5),
			/* Welcome user */
			NWidget(NWID_HORIZONTAL),
				NWidget(NWID_SPACER), SetMinimalSize(3,0), SetFill(0, 1),
				NWidget(WWT_TEXT, COLOUR_GREY, CC_TOKEN_USER), SetDataTip(STR_CC_TOKEN_WELCOME, STR_NULL), SetMinimalSize(200, 20),
			EndContainer(),
			/* Login button */
			NWidget(NWID_HORIZONTAL), SetPIP(2, 2, 2), SetPadding(10, 100, 10, 100),
				NWidget(WWT_PUSHTXTBTN, COLOUR_ORANGE, CC_TOKEN_LOGIN), SetMinimalSize(60, 40),SetFill(1, 0), SetDataTip(STR_CC_TOKEN_LOGIN, STR_CC_TOKEN_LOGIN_TOOLTIP),
			EndContainer(),
			NWidget(NWID_SPACER), SetMinimalSize(0, 5), SetFill(1, 1),
			/* several buttons */
			NWidget(NWID_HORIZONTAL ), SetPadding(0, 15, 0, 15),
				NWidget(WWT_PUSHTXTBTN, COLOUR_ORANGE, CC_TOKEN_WEBSITE), SetMinimalSize(55, 30),SetFill(1, 0), SetDataTip(STR_NETWORK_SERVER_LIST_JOIN_GAME_CC_WEBSITE, STR_NETWORK_SERVER_LIST_JOIN_GAME_CC_WEBSITE_TOOLTIP),
				NWidget(NWID_SPACER), SetMinimalSize(5,0), SetFill(0, 1),
				NWidget( WWT_PUSHTXTBTN, COLOUR_ORANGE, CC_OTHER_IRC_CHAT ), SetMinimalSize(55, 30),SetFill(1, 0), SetDataTip( STR_CC_IRC_LINK_CHAT, STR_CC_IRC_LINK_CHAT_TOOLTIP ),
				NWidget(NWID_SPACER), SetMinimalSize(5,0), SetFill(0, 1),
				NWidget(WWT_PUSHTXTBTN, COLOUR_ORANGE, CC_OTHER_IRC_SERVERS ), SetMinimalSize(50, 30),SetFill(1, 0), SetDataTip( STR_CC_IRC_LINK_SERVERS, STR_CC_IRC_LINK_SERVERS_TOOLTIP ),
				NWidget(NWID_SPACER), SetMinimalSize(5,0), SetFill(0, 1),
				NWidget(WWT_PUSHTXTBTN, COLOUR_ORANGE, CC_OTHER_WIKI_RULES ), SetMinimalSize(50, 30),SetFill(1, 0), SetDataTip( STR_CC_WIKI_RULES_PAGE, STR_CC_WIKI_RULES_PAGE_TOOLTIP ),
			EndContainer(),
